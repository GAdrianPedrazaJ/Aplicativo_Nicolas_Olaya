      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-8 max-w-7xl mx-auto space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h2 className="text-4xl font-black text-slate-900 tracking-tight uppercase">CENTRO DE REPORTES</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select className="w-full pl-4 pr-10 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl appearance-none focus:bg-white focus:ring-4 focus:ring-emerald-500/5 focus:border-[#005d5d] transition-all outline-none text-slate-700 font-bold text-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <div className="relative">
                        ...
                        <input
                          type="date"
                          className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-emerald-500/5 transition-all outline-none text-sm font-bold text-slate-700"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 space-y-3">
                    <button className="w-full btn-primary flex items-center justify-center gap-2 py-4 shadow-lg shadow-emerald-900/10">
                      <Download size={18} />
                      GENERAR REPORTE
                    </button>
                  </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm group hover:border-[#005d5d]/30 transition-all">
                  <div className="bg-emerald-50 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <FileSpreadsheet className="text-[#005d5d]" size={28} />
                  </div>
                  ...
                  <span className="text-[10px] font-black text-[#005d5d] uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">Recomendado</span>
                </div>
                    ...
                    <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all">
                      <div className="flex items-center gap-4">
                        <div className="bg-white p-2.5 rounded-xl shadow-sm">
                          <FileText className="text-[#005d5d]" size={20} />
                        </div>
                        <div>
                          <p className="text-sm font-black text-slate-800 uppercase tracking-tight">Reporte_Produccion_S{i+12}_2024.xlsx</p>
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Generado hace {i * 2} horas</p>
                        </div>
                      </div>
                      <button className="p-2 text-slate-400 hover:text-[#005d5d] transition-colors">
                        <Download size={18} />
                      </button>
                    </div>
                  ))}
